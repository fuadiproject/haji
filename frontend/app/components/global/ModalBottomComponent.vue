  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        <div
          ref="modalRef"
          class="relative flex h-[90vh] max-h-[90vh] w-full max-w-[440px] transform flex-col rounded-t-2xl bg-white shadow-2xl transition-transform duration-150 ease-out sm:h-[90vh] sm:max-h-[90vh] md:h-[85vh] md:max-h-[85vh]"
