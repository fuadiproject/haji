    ...
    <div class="flex h-full flex-col">
      ...
      >
         <!-- Toggle Button --> <button
          ...
          :class="[isCollapsed ? 'rotate-180 top-4' : 'top-6']"
          @click="toggleSidebar"
        >
           <UIcon name="ph:caret-left" class="h-4 w-4" /> </button
        > <NuxtImg
          src="/images/logo.svg"
          alt="Logo"
        ...
        <ul class="space-y-2">
          ...
          <li v-for="item in menuItems" :key="item.id">
            ...
            <div v-if="item.children">
             ...
             <!-- Regular Menu Item (no children) --> <NuxtLink
              v-else
              :to="item.to"
              ...
              > <UIcon :name="item.icon" class="h-5 w-5 flex-shrink-0" /> <span
                v-show="!isCollapsed"
                class="transition-opacity duration-300"
                >{{ item.name }}</span
              > <!-- Tooltip for collapsed state -->
      ...
      >
         <NuxtLink
          ...
          > <UIcon name="ph:user-circle" class="h-5 w-5 flex-shrink-0" /> <span
            v-show="!isCollapsed"
            class="transition-opacity duration-300"
            >Akun</span
          > <!-- Tooltip for collapsed state -->
